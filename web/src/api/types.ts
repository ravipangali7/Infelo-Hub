...
export interface Campaign {
  ...
  image: string;
  image_url: string | null;
  og_share_title?: string;
  og_share_description?: string;
...
export interface SiteSetting {
  ...
  title: string;
  subtitle: string;
  seo_home_meta_title?: string;
  seo_home_meta_description?: string;
  seo_home_meta_keywords?: string;
  seo_home_og_image?: string;
  seo_home_og_image_url?: string | null;
  seo_shop_meta_title?: string;
  seo_shop_meta_description?: string;
  seo_shop_meta_keywords?: string;
  seo_shop_og_image?: string;
  seo_shop_og_image_url?: string | null;
  seo_campaigns_list_meta_title?: string;
  seo_campaigns_list_meta_description?: string;
  seo_campaigns_list_meta_keywords?: string;
  seo_campaigns_list_og_image?: string;
  seo_campaigns_list_og_image_url?: string | null;
  seo_learn_meta_title?: string;
  seo_learn_meta_description?: string;
  seo_learn_meta_keywords?: string;
  seo_learn_og_image?: string;
  seo_learn_og_image_url?: string | null;
  phone: string;
  whatsapp: string;
  email: string;
  facebook: string;
